...
// Sprint 55 classified attributes, and every one is safe to ignore: the
// cost is a diagnostic or a missed optimization, never a wrong answer.
//
...
static int helper(void) __attribute__((__unused__, __always_inline__));
