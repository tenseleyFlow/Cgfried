...
# cached once. The upstream-default static-library closure and 30-suite
# self-test run independently from the complete symmetric-only closure,
# generated upstream test-suite harness, normal C programs, and standalone
# one-file fuzz programs; both profiles run offline.
